        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
					...
					<form action="<?php base_url()?>user/insert" method="post">
                            ...
                            <div class="p-t-15">										
								<button class="btn btn--radius-2 btn--blue" type="submit">Add New</button>								
							</div>
					</form>
				</div>
            </div>
	...
	<table cellpadding="0" cellspacing="0" border="0">
		...
		<?php
			...
			echo "<tr>"
				...
				."<td> $re->brand</td>"
				."<td> $re->date</td>"
				."<td><a href='".base_url()."user/view/$re->i_id'>Edit</a> | <a href='".base_url()."user/delete/$re->i_id'>Delete</a></td>"
				."</tr>"
		?>
	</table>
</div>
